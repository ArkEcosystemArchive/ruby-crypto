...
require 'ark_crypto/transactions/delegate_registration'

describe ArkCrypto::Transactions::DelegateRegistration do
  ...
  describe '#create' do
    ...
    subject { described_class.new.create(username, secret, second_secret) }
