...
describe ArkEcosystem::Crypto::Deserializers::MultiSignatureRegistration do
  describe '#deserialize' do
    it 'should be ok if signed with a passphrase' do
      transaction = JSON.parse!(File.read('spec/fixtures/transactions/type-4/passphrase.json'), object_class: OpenStruct)
